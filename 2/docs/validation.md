...
**另一序列 `freiburg1_xyz`（中速、translation 為主）全程貼合真值**：yaw 8.0° / pitch 7.1° / roll 2.0°，幾何旋轉 MAE **11.9°**（對照 desk 的 55.8°）。README 有逐幀對比動畫（GIF）。這證明本系統在**中等速度真實序列**能穩定跟住真值，漂移只出現在最難的快速＋模糊序列。
